$(function () {
    ...
    $("#modif").click(function () {
        var Id = tab[0];
        window.location.href = "routinejournalier_modifier-" + Id;
    });
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "php/controller/routinejournalier.php?supprimer=" + Id, //process to mail
                        data: '',
    ...
    $('.testModal').click(function () {
        ...
        $('#quantiteUpdate').val(data[4]);
        $("#idRoutines").val(data[5]);
