<script type="text/javascript" src="php/view/sardin/sardin.js"></script>
    ...
    <div class="row">
      <div class="col s12 m12 l12">
        ...
        <?php
            ...
            $Sardin = new Sardin();
            $list = $Sardin->rechercheSardin($opt[1]);
            ...
            <form class="col s12" id="monFormMod" class="needs-validation" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input type="hidden" name="modifier" value="<?php echo $value['idSardin'] ?>">
                  <button class="btn green waves-effect waves-light right" type="submit" name="modifier">Valider</button>
                  <a class="btn mr-1 red waves-effect waves-light right" href="sardin_liste">Annuler
                  </a>
                </div>
              </div>
            </form>
