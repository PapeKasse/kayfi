$(function () {
    ...
    $('#monForm').on('submit', function (e) {
        ...
        $.ajax({  
            method: "POST",
            url: "php/controller/sardin.php", //process to mail
            data: new FormData(this),
            contentType:false,
            processData:false,
            success: function (msg) {
                if (parseInt(msg)==1){              
                    swal({ title: "Bravo !", text: "Le Sardin a &eacute;t&eacute; ajout&eacute; avec succ&egrave;s", imageUrl: 'images/icones/success.png', html: true });
                    $(document).click(function(){
                        window.location.href = "sardin_liste";
                    });
    ...
    $('#monFormMod').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (parseInt(msg) == 1) {
                    swal({ title: "Bravo !", text: "Le Sardin a &eacute;t&eacute; modifi&eacute; avec succ&egrave;s", imageUrl: 'images/icones/success.png', html: true });
                    $(document).click(function () {
                    window.location.href = "sardin_liste"; 
                    });
                } else if (parseInt(msg) == 2) {
                    swal({ title: "Erreur", text: "Ce Sardin existe d&eacute;j&agrave;", imageUrl: 'images/icones/error.png', html: true });
                } else {
                    swal({ title: "D&eacute;sol&eacute;", text: "Une erreur est survenue lors de la connexion &agrave; la base de donn&eacute;es, veuillez r&eacute;essayer plus tard", imageUrl: 'images/icones/errorDb.png', html: true });
                }
                // alert(msg);
