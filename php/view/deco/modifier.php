<script type="text/javascript" src="php/view/deco/deco.js"></script>
            ...
            <form class="col s12" id="monFormMod" class="needs-validation" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s12">
                  <input type="hidden" name="modifier" value="<?php echo $value['idDeco'] ?>">
                  <button class="btn green waves-effect waves-light right" type="submit" name="modifier">Valider</button>
                  <a class="btn mr-1 red waves-effect waves-light right" href="deco_liste">Annuler
                  </a>
                </div>
              </div>
            </form>
