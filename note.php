        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="our-link">
                        <ul>
                            <li><a style="font-size: 15px;font-weight:600;" href="#"><i class="fa fa-envelope"> </i> Kayfi@gmail.com</a></li>
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">KAYFI</span>MEDINA</h1>
                </a>
            </div>
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    <h2 class="section-title px-5 mb-3"><span class="bg-secondary px-2">Rester A Jour</span></h2>
                    <p>Recever diréctement tous les nouvautés de Kayfi par Email.</p>
                </div>
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-white" placeholder="Votre Email ">
                        <div class="input-group-append">
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-6">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">KAYFI</span>MEDINA</h1>
                </a>
                <p>CONTACTEZ-NOUS .</p>
                <p class="mb-2"><i class="fa fa-map-marker text-primary mr-3"></i>Rue 7 Angle 12, Médina, Dakar</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>kayfi@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone fa-spin text-primary mr-3"></i>+221 77 712 51 50</p>
                <p class="mb-0"><i class="fa fa-phone fa-spin text-primary mr-3"></i>+221 77 488 51 11</p>
                </br>
...
<script src="kayfi_css_js/js/monjs.js"></script>
    ...
    <script src="kayfi_css_js/js/lib/easing/easing.min.js"></script>
    <script src="kayfi_css_js/js/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="kayfi_css_js/js/mail/jqBootstrapValidation.min.js"></script>
    <script src="kayfi_css_js/js/mail/contact.js"></script>
