...
//Sampel Line Chart 
 ...
 var BarChartSampleData = {
    labels: ["Janvier", "Fevier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre"],
    datasets: [
        {
            label: "My First dataset",
            ...
            data: [65, 59, 80, 81, 56, 55, 40, 30, 70, 80, 100, 58]
        },
        {
            label: "My Second dataset",
            ...
            data: [28, 48, 40, 19, 86, 27, 90, 15, 40, 50, 80, 0]
        }
    ]
};
